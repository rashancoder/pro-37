class Question {
  ...
  display(){
  this.title.html("Question about animals");
  this.title.html("choose the correct number correlating to the animal")
  this.title.position(350,0);

  this.question.html("what animal had a long neck?");
  this.question.position(100,30);
  this.option1.html("1: Dog");
  this.option1.position(150,60);
  this.option2.html("2: Zebra");
